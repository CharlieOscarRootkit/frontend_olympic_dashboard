    ...
    <main className="dark:bg-gray-900/80">
      <div className="py-16 md:py-24 lg:py-32">
        <div className="mx-auto max-w-xl bg-[#f2f2f7] dark:bg-gray-800 px-5 py-12 text-center md:px-10">
          ...
          <Link href="#" className="mx-auto flex max-w-sm justify-center bg-[#276ef1] dark:bg-gray-700 px-8 py-4 text-center font-semibold text-white transition shadow-lg dark:shadow-none hover:shadow-lg">
          ...
          <form className="mx-auto mb-4 max-w-sm pb-4" name="wf-form-password" method="get">
            <div className="relative">
              ...
              <input type="email" className="mb-4 block h-9 w-full border border-black bg-white dark:bg-gray-900 px-3 py-6 pl-14 text-sm text-[#333333] dark:text-gray-400" maxLength="256" name="name" placeholder="Email Address" required />
            </div>
            ...
            <Link href="#" className="flex max-w-full grid-cols-2 flex-row items-center justify-center bg-[#276ef1] dark:bg-gray-700 px-8 py-4 text-center font-semibold text-white transition shadow-lg dark:shadow-none hover:shadow-lg">
